...
class TestSchemaCreation:
    ...
    def test_table_counts_all_zero_on_fresh_db(self, db_path):
        ...
        assert counts["schema_migrations"] == 14  # v1-v10 as noted previously + v11 AI discovery/collection/verification platform + v12 Sourcing Agent + v13 Apollo contacts + v14 Procurement Decision Engine foundation
