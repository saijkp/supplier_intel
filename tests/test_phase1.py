...
class TestSchemaCreation:
    ...
    def test_table_counts_all_zero_on_fresh_db(self, db_path):
        ...
        assert counts["schema_migrations"] == 33  # v1-v10 as noted previously + v11 AI discovery/collection/verification platform + v12 Sourcing Agent + v13 Apollo contacts + v14 Procurement Decision Engine foundation + v15 Procurement Decision Engine Phase 3 + v16 scoring engine rewrite + v17 self_asserted_score + v18 CSV batch upload (batch_upload_rows/field_provenance) + v19 batch_upload_rows.name_extraction_note + v20 supplier_phone_numbers/contact_source_pages + v21 factory_location/candidate_facility_photo_urls + v22 supplier_reputation_snippets + v23 companies_house verification + v24 catalogue-depth evidence + v25 reverse-image-search evidence import + v26 reputation_search_attempted_at + v27 capability_extraction_status + v28 drop supplier_catalogue_signals.signal_type CHECK + v29 audit_verdicts + v30 supplier_snapshots/supplier_monitoring_settings + v31 pipeline_jobs.updated_at (stalled-job watchdog) + v32 factory_facts_verdict + v33 public_token/public_pass_created_at/public_pass_revoked_at (Verified trade-show pass)
